...
parser = argparse.ArgumentParser(
    description=" Animal Detection Cropping through using MegaDetector with no filtering",
...
'''
Parses JSON to collect image detections
'''
...
'''
Processes the MD output and then either visualises or crops the detections in the images
'''
